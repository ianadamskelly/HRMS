            ...
            <main className="flex-1 p-4 md:p-6 lg:p-8">
                <Accordion type="single" collapsible defaultValue="item-1" className="w-full">
                    <AccordionItem value="item-1">
                        <AccordionTrigger>Goal Setting</AccordionTrigger>
                        <AccordionContent>
                            <Card>
                                <CardHeader>
                    ...
                    <AccordionItem value="item-2">
                        <AccordionTrigger>Continuous Feedback</AccordionTrigger>
                        <AccordionContent>
                            <Card>
                                <CardHeader>
                    ...
                    <AccordionItem value="item-3">
                        <AccordionTrigger>Performance Appraisal</AccordionTrigger>
                        <AccordionContent>
                            <Card>
                                <CardHeader>
